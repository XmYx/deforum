...
from deforum import DeforumAnimationPipeline, root_path
...
from trt_yank.exporter import export_onnx, export_trt
from trt_yank.utilities import PIPELINE_TYPE, Engine
from trt_yank.models import make_OAIUNetXL, make_OAIUNet
import logging
import gc
import torch
from trt_yank.model_manager import modelmanager, cc_major
...
def export_unet_to_trt(
    ...
    unet_hidden_dim = model.model.diffusion_model.in_channels
    ...
    modelobj = make_OAIUNetXL(
        version, pipeline, "cuda", False, 1, opt_textlen, max_textlen
    )
...
def apply_trt_model(self, x, t, c_concat=None, c_crossattn=None, control=None, transformer_options={}, **kwargs):
