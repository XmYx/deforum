...
class Deforum:
    ...
    def __call__(self, *args, **kwargs):
        ...
        if classic:
            self.render_animation(self.args,
                             self.anim_args,
                             self.video_args,
                             self.prompt_series,
                             self.loop_args,
    ...
    def render_animation(self,
        ...
        while frame_idx < anim_args.max_frames:
            ...
            if anim_args.enable_noise_multiplier_scheduling and keys.noise_multiplier_schedule_series[
            ...
            if turbo_steps > 1:
                ...
                for tween_frame_idx in range(tween_frame_start_idx, frame_idx):
                    ...
                    done = self.datacallback({"cadence_frame": Image.fromarray(img)})
            ...
            if prev_img is not None:
                # apply transforms to previous frame
                prev_img, depth, mask = anim_frame_warp(prev_img, args, anim_args, keys, frame_idx, depth_model, depth=None,
            ...
            if optical_flow_redo_generation != 'None' and prev_img is not None and strength > 0:
                ...
                disposable_image = self.generate(args, keys, anim_args, loop_args, controlnet_args, root, sampler_name=scheduled_sampler_name)
                disposable_image = cv2.cvtColor(np.array(disposable_image), cv2.COLOR_RGB2BGR)
